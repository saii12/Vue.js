  ...
  data() {
    return {
      ...
      persons: [
        ...
        { uid: "a105", name: "이순신", age: 53 }, // prettier 플러그인의 기능이 ,자동으로 붙음 / 띄어쓰기도
      ],
      value1: "tit1",
      value2: "tit2",
      count: 0,
...
<template>
  ...
  <!--양방향 바인딩 : 프론트에서 myName값을 수정하면 v-model에 바로 반영-->
  ...
  <p>
    {{ myCities }}<br />
    <!-- 체크 된 값들이 myCities로 들어가면서 출력-->
    <label><input type="checkbox" v-model="myCities" value="서울" /></label>
    <label><input type="checkbox" v-model="myCities" value="대전" /></label>
    <label><input type="checkbox" v-model="myCities" value="대구" /></label>
    <label><input type="checkbox" v-model="myCities" value="부산" /></label>
    <label><input type="checkbox" v-model="myCities" value="광주" /></label>
  </p>
